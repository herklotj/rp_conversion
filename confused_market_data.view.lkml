view: confused_market_data {
  derived_table: {
    ...
    q.quote_id,
              ...
              CASE WHEN to_date(q.quote_dttm) >= '2021-04-21'  AND marginpricetest_indicator_desc = '26: Aug18' THEN 'NEW (26)' WHEN to_date(q.quote_dttm) >= '2021-04-28' AND marginpricetest_indicator_desc = '32: NM Jul18 - New Margin' THEN 'NEW (32)' WHEN to_date(q.quote_dttm) >= '2021-05-14' AND marginpricetest_indicator_desc = '33: M July19' THEN 'NEW (33)'ELSE 'OLD' END AS model_type,
             CASE
