view: conversion {
  derived_table: {
    sql: SELECT
          ...
          ra.pi_rated_area,
           CASE WHEN to_date(c.quote_dttm) >= '2021-05-21' AND marginpricetest_indicator_desc = '26: Aug18' THEN 'NEW(26 - MI)' WHEN to_date(c.quote_dttm) >= '2021-04-21'  AND marginpricetest_indicator_desc = '26: Aug18' THEN 'NEW (26)' WHEN to_date(c.quote_dttm) >= '2021-04-28' AND marginpricetest_indicator_desc = '32: NM Jul18 - New Margin' THEN 'NEW (32)' WHEN to_date(c.quote_dttm) >= '2021-05-14' AND marginpricetest_indicator_desc = '33: M July19' THEN 'NEW (33)' WHEN to_date(c.quote_dttm) >= '2021-05-21'  AND marginpricetest_indicator_desc = '35: NM July 19' THEN 'NEW (35)' ELSE 'OLD' END AS model_type,
          CASE
